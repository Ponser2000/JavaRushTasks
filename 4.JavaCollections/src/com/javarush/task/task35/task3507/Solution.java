...
public class Solution {
  ...
  public static Set<? extends Animal> getAllAnimals(String pathToAnimals) {
    ...
    // Читаем список файлов в переданной директории
    ...
    // Выбираем файлы соответствующие условию задачи
    ...
    for (String p : pathes) {
      try {
        ...
        // Создаем собственный загрузчик классов
        ...
        // Загружаем класс для анализа

        String className = p.substring(0, p.length() - 6);
        Class clazz = loader.loadClass(className);

        // Получаем список интерфесов в загруженном классе
        ...
        // Получаем список конструкторов в загруженном классе
  ...
  // Метод загрузки фалов для последующего анализа
