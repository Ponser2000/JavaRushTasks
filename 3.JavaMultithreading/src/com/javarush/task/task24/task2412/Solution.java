    ...
    public static void sort(List<Stock> list) {
        ...
        list.sort(new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                Double profit1 = stock1.containsKey("open") ? (double) stock1.get("last") - (double) stock1.get("open") : (double) stock1.get("change");
                Double profit2 = stock2.containsKey("open") ? (double) stock2.get("last") - (double) stock2.get("open") : (double) stock2.get("change");
