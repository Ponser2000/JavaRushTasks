...
public class Solution {
    ...
    public static boolean isModifierSet(int allModifiers, int specificModifier) {
        String str = String.format("%32s", Integer.toBinaryString(allModifiers)).replaceAll(" ", "0");
        System.out.println(str);
        str = String.format("%32s", Integer.toBinaryString(specificModifier)).replaceAll(" ", "0");
        System.out.println(str);



        boolean res = (allModifiers & specificModifier) == specificModifier ? true : false;
        return res;
    }
